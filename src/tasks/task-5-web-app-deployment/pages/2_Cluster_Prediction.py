...
def main():
    ...
    with col2:
            ...
            st.text('- Decent work and Economic growth') 
            st.text('- Disaster') 
            st.text('- Industry')
            st.text('- Innovation')
            st.text('- Infrastructure, Healthcare and Poverty')
            st.text('This application can help us in identifying the improvements required in different areas(features) to move a particular municipality from high vulnerability cluster to low vulnerability cluster.')
